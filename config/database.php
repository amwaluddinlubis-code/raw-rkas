...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'school' => [
            'driver' => 'sqlite',
            'database' => rtrim(env('SPJ_DATA_PATH', storage_path('app')), '/\\').(str_starts_with(strtolower(basename((string) env('SPJ_DATA_PATH', ''))), 'school-databases') ? '' : DIRECTORY_SEPARATOR.'school-databases').DIRECTORY_SEPARATOR.'_unselected.sqlite',
            'prefix' => '',
