<x-layouts.tailwind-app title="Detail Pegawai">
    ...
    <div class="space-y-6">
        ...
        <section class="overflow-hidden rounded-2xl border border-[var(--ui-line)] bg-[var(--ui-surface-base)] shadow-sm">
            <div class="border-b border-[var(--ui-line)] p-5">
                ...
                @foreach(\App\Models\EmployeeCertificate::kinds() as $kind => $kindLabel)
                    ...
                    <li class="px-5 py-3.5">
                        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                            <div class="min-w-0">
                                <p class="font-bold text-[var(--ui-fg-strong)]">{{ $kindLabel }}</p>
                                @if($cert)
                        ...
                        <details class="mt-2">
                            ...
                            <form method="POST" action="{{ $cert ? route('employees.certificates.update', $cert) : route('employees.certificates.store', $employee) }}" class="mt-2 grid gap-2 sm:grid-cols-2">
                                @csrf
